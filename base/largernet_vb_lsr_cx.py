...
from function_connectivity import take_section, all_to_all_connect, one_to_one_connect, some_to_some_connect, cortical_connect, data_output
########################################################################
###### specify numbers of cells of each type
ncell_tc = 16
ncell_re = 12
ncell_in = 4
...
#for sect in h.allsec():  # examine the existing segments loaded in the model
#		print sect.name()
########################################################################	
...
###### setting up connectivity with relevant parameters
...
########################################################################	
###### plotting Poisson-driven trains
for i in range(0, ncell_tc):
