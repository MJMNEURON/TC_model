# for running the all conditions of contrast with smallnet
########################################################################
###### this script:
...
from function_connectivity import take_section, all_to_all_connect, one_to_one_connect, data_output
